...
var HtmlProjectGenerator = /** @class */ (function (_super) {
    __extends(HtmlProjectGenerator, _super);
    function HtmlProjectGenerator(generator, componentGenerator) {
        var _this = _super.call(this, generator) || this;
        _this.componentGenerator = componentGenerator;
        return _this;
    }
    // tslint:disable-next-line:no-shadowed-variable
    HtmlProjectGenerator.prototype.generate = function (project, options) {
        var _this = this;
        ...
        if (components) {
            Object.keys(components).map(function (componentName) {
                ...
                var componentResults = _this.componentGenerator.generate(component, project);
        ...
        if (pages) {
            Object.keys(pages).map(function (pageName) {
                ...
                var pageResults = _this.componentGenerator.generate(page, project);
    ...
    return HtmlProjectGenerator;
}(teleport_lib_js_1.ProjectGenerator));
exports.default = HtmlProjectGenerator;
